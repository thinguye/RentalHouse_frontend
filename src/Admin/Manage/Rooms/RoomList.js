                    ...
                    <TransitionGroup>
                        <CSSTransition component="div" className="TabsAnimation"
                            ...
                            <div>
                                        ...
                                        {this.state.rooms.map((room) => (
                                            <tr style={{ backgroundColor: this.setColor(room.state) }} v-for="item in tableItems" key={room.id}>
                                                ...
                                                <td>
                                                    <Row>
                                                        <Col>
                                                            <Button style={{ border: 'none' }} variant='outline-success' onClick={(e) => this.handleShowCreate(room.id)}><FaPlus /></Button>
                                                        </Col>
                                                        <Col>
                                ...
                                <Modal show={this.state.showCreate} onHide={(e) => this.handleCloseCreate()} style={{top:'30%'}}>
                                    <Modal.Header closeButton>
                                        ...
                                        <Form>
                                            <Row>
                                                <FormGroup>
                                                    ...
                                                    <Input type="text" name="username"
                                                        placeholder="Nhập tên tài khoản" value={this.state.username}
                                            ...
                                            <FormGroup>
                                                ...
                                                <Input type="text" name="password"
                                                    placeholder="Nhập mật khẩu" value={this.state.password}
                                                    onChange={this.onPasswordChange} pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" title="Mật khẩu bao gồm tối thiểu chữ hoa, chữ thường, chữ số, kí tự đặt biệt và có ít nhất 8 kí tự" required />
                                            </FormGroup>
                                        </Form>
                                    </Modal.Body>
                                    <Modal.Footer>
                                        <Button onClick={(e) => this.createAccount()} type="submit" color="primary">
                                            Thêm
                                        </Button>
                                        <Button variant="danger" onClick={(e) => this.handleCloseCreate()}>
                                            Thoát
                                        </Button>
                                    </Modal.Footer>
                                </Modal>
