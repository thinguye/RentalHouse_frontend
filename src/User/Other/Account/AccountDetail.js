...
export default class AccountDetail extends Component {
    ...
    handleSubmit = () => {
        if (this.state.password === this.state.confirmPass) {
            instance.post(`api/Account/ChangePassword?password=${this.state.password}`)
                .then(res => {
                    if (res) {
                        this.setState({
                ...
                .catch((error) => this.setState({
                    contentAlert: "Mật khẩu bao gồm chữ hoa, chữ thường, số, kí tự đặt biệt và có ít nhất 8 kí tự",
                    alertback: "danger"
                }))
        } else {
            this.setState({
                ...
                <TransitionGroup>
                    <CSSTransition
                        ...
                        <div style={{ maxWidth: '50%' }}>
                            <Form>
                                <FormGroup>
                                    ...
                                    <Input type="password"
                                        ...
                                        value={this.state.password} pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$"
                            ...
                            <Alert style={{ marginTop: '2rem' }} variant={this.state.alertback} show={this.state.show} onClose={(e) => this.setClose()} dismissible>
